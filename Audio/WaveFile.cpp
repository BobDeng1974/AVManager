...
//-----------------------------------------------------------------------------
HRESULT CWaveFile::Open( LPCTSTR strFileName, WAVEFORMATEX* pwfx, DWORD dwFlags )
{
	HRESULT hr;
	...
	if( m_dwFlags == WAVEFILE_READ )
	{
		...
		m_hmmio = mmioOpen( const_cast<LPWSTR>(strFileName), NULL, MMIO_ALLOCBUF | MMIO_READ );
	...
	{
		m_hmmio = mmioOpen( const_cast<LPWSTR>(strFileName), NULL, MMIO_ALLOCBUF |
			MMIO_READWRITE |
			MMIO_CREATE );
		if( NULL == m_hmmio )
			return E_FAIL;
