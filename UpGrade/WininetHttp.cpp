...
string CWininetHttp::Request(LPCWSTR lpUrl, HttpRequest type, LPCWSTR lpPostData/* = NULL*/, LPCWSTR lpHeader/*=NULL*/)
{
	string strRet;
	try
	{
		...
		{
			DWORD dwSize = (lpPostData==NULL)?0:_tcslen(lpPostData);
